...
type CommunityFinanceBannerProps = {
  data: {
...
const CommunityFinanceBannerFields: YextFields<CommunityFinanceBannerProps> = {
  data: {
    label: "Banner Text",
    type: "object",
    objectFields: {
...
const CommunityFinanceBannerComponent: PuckComponent<CommunityFinanceBannerProps> = ({
  data,
  styles,
  section,
  puck,
...
export const CommunityFinanceBanner: YextComponentConfig<CommunityFinanceBannerProps> = {
  label: "Banner",
  fields: toPuckFields(CommunityFinanceBannerFields),
  defaultProps: {
    data: {
      text: {
        field: "",
  ...
  render: (props) => (
    ...
    >
      <CommunityFinanceBannerComponent {...props} />
    </VisibilityWrapper>
  ),
};
